        ...
        <div className="container mx-auto lg:px-20 px-10">
            ...
            <div className="my-3 px-4 lg:px-6 flex flex-col justify-top align-text-top flex-1">
              ...
              <TextFade>
                <div className="text-sm ml-10">
                  <Zimage
                src="/assets/ebg/CDLogo.png"
                alt={"Crimson dust, the project's icon. "}
              />
                </div>
              </TextFade>
            </div>
            ...
            <div className="my-3 px-4 lg:px-6 flex flex-col justify-center align-top flex-1">
              <TextFade>
                ...
                <p className="my-2">
                  * Engine:{" "}
                  <span className="text-off-white/80">
                    Unreal Engine, Singleplayer, C++, Blueprint
                  </span>
                </p>
                <p className="my-2">
                  * Team Size:{" "}
                  <span className="text-off-white/80">20+ (studio) / 4 (programmer) </span>
                </p>
                <p className="my-2">
                  * Time:{" "}
                  <span className="text-off-white/80">Ongoing</span>
                </p>
                <p className="my-2">
                ...
                <p className="my-2">
                  * Genre & Keywords:{" "}
                  <span className="text-off-white/80">
                    Hack and Slash, Stylish Combat, Hell Aesthetic, AI enemies.
                  </span>
                </p>
              </TextFade>
            </div>
          ...
          <div className="flex lg:flex-row flex-col">
                ...
                <p className="my-5">
                  * A stylish  {" "}
                  <span className="text-accent">
                    Hack and Slash game
                  </span> with an emphasis on fuild, <span className="text-accent">fast paced, anti-button mashing </span>
                  combat experience. 
                </p>
                <p className="my-5">
                  * Built in Unreal 5 with{" "}
                  <span className="text-accent">an in house GAS implementation</span> and blueprint support. 
                </p>

                <p className="my-5">
                  * Focsed on creating a aesthetic first, {" "}
                  <span className="text-accent">coehesive </span> and fun gameplay experience.
                </p>
              </TextFade>
            </div>
            ...
            <div className="flex flex-col justify-center items-center">
              <Zimage
                src="/assets/ebg/cassian.png"
                alt={" Splash art of game, featuring cassian. "}
              />

              <p className="text-off-white/50 font-thin">
                Splash art of game, featuring cassian. 
              </p>
            </div>
          </TextFade>
          ...
          <div className="flex my-15 mx-10 flex-row align-top">
            ...
            As a developer, they were looking for someone with {" "}
            <span className="text-accent">AI unreal engine expertise </span>and be able to be flexible with 
            their skills in{" "}
            <span className="text-accent">both C++ and blueprints</span> to increase the speed and efficiency of the dev team. 
          </p>
          </div>
