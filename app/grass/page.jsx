        ...
        <div className="container mx-auto lg:px-20 px-10">
          ...
          <div className="my-3 px-4 lg:px-6">
            <TextFade>
              ...
              <p className="my-5">
                * Focused on Artsit facing features that empower devs, toolage
                and GPU optimisation.
              </p>
            </TextFade>
          </div>
          ...
          <TextFade>
            ...
            <p className="my-5">
              * Inspired from the grass from breath of the wild, this project
              for my dissertation features a scene with multiple million grass
              blades, each individually animated.{" "}
            </p>

            <p className="my-5">
              * The focus of this project was to implement a more simplified
              (albeit scalable) version of modern day foliage system. This
              project taught me a lot about{" "}
              <span className="text-accent">
                {" "}
              ...
              , general color correction and uv translation. Managing scope
              creep in a project like this was also essential, and it allowed me
              to finish a presentable demo on time that I was proud of.{" "}
            </p>
            <p className="my-5">
              * The final build features a scene with{" "}
              ...
              change the wind direction and speed built on ImGui is also
              present. Additional tech art features include: height-based color
              blending, brightness, contrast,saturation and gamma correction
              support, and a camera basedregion support.
            </p>
